...
void UAGR_CombatManager::DoCollisionTest_SimpleLineTrace(UPrimitiveComponent* Mesh, const FColor DebugTraceColor)
{
...
void UAGR_CombatManager::DoCollisionTest_SimpleBoxTrace(UPrimitiveComponent* Mesh, const FColor DebugTraceColor)
{
    TArray<FHitResult> HitResults;
