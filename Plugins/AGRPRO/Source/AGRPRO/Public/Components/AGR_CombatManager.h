...
protected:
    ...
    void HandleOnAttackHitEvent(const bool bHit, const TArray<FHitResult>& HitResults, UPrimitiveComponent* Mesh);
    void DoCollisionTest_SimpleLineTrace(UPrimitiveComponent* Mesh, const FColor DebugTraceColor);
    void DoCollisionTest_SimpleBoxTrace(UPrimitiveComponent* Mesh, const FColor DebugTraceColor);
    void DoCollisionTest_SimpleCapsuleTrace(UPrimitiveComponent* Mesh, const FColor DebugTraceColor);
