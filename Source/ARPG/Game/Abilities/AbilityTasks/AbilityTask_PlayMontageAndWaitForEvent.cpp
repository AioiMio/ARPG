...
void UAbilityTask_PlayMontageAndWaitForEvent::Activate()
{
	...
	if (RPGAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = RPGAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UAbilityTask_PlayMontageAndWaitForEvent::OnGameplayEvent));
...
UARPGAbilitySystemComponent* UAbilityTask_PlayMontageAndWaitForEvent::GetTargetASC()
{
