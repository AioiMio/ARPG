...
public:
	...
	ATTRIBUTE_ACCESSORS(UARPGAttributeSet, HealthRegenRate)
	...
	ATTRIBUTE_ACCESSORS(UARPGAttributeSet, XP)
	...
	ATTRIBUTE_ACCESSORS(UARPGAttributeSet, XPBounty)
	...
	ATTRIBUTE_ACCESSORS(UARPGAttributeSet, Gold)
	...
	ATTRIBUTE_ACCESSORS(UARPGAttributeSet, GoldBounty)
